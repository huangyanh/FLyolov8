...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/FLv3_5/weights/best.pt', help='trained weights path')  #'runs/train/yolov5_2/weights/best.pt' server_last_v3_5.pt
    parser.add_argument('--batch', type=int, default=16, help='total batch size for all GPUs')    # 32
    parser.add_argument('--imgs', nargs='+', type=int, default=[640, 640], help='[height, width] image sizes')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--warmup', default=100, type=int, help='warmup time')  #200
    parser.add_argument('--testtime', default=200, type=int, help='test time')   #400
